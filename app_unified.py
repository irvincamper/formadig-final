...
def register_blueprints():
    ...
    # Ubicación raíz de la aplicación (donde está este archivo)
    root_path = os.path.dirname(os.path.abspath(__file__))
    
    # Ruta a los módulos: Formadig/1_Sistema_DIF_Acatlan/modulos
    base_path = os.path.join(root_path, "Formadig", "1_Sistema_DIF_Acatlan")
