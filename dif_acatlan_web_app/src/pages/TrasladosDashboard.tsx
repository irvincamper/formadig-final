      ...
      <div className="dashboard-grid">
        <div className="card glass-panel fade-in">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ padding: '1rem', background: 'rgba(76, 175, 80, 0.1)', borderRadius: 'var(--radius-sm)', borderLeft: '4px solid var(--success)' }}>
              <div style={{ fontWeight: 'bold' }}>Ambulancia 01</div>
              <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Estado: Operativa - En Base</div>
            </div>
            <div style={{ padding: '1rem', background: 'rgba(255, 152, 0, 0.1)', borderRadius: 'var(--radius-sm)', borderLeft: '4px solid var(--warning)' }}>
